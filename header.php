      ...
      <div class="site-header__menu group">
        <nav class="main-navigation">
          ...
          <ul>
            ...
            <li <?php if (get_post_type() == "program") echo 'class="current-menu-item"' ?> </li><a href="<?= get_post_type_archive_link("program") ?>">Programs</a></li>
        ...
        <div class="site-header__util">
          ...
          <?php } else { ?>
            ...
            <a href="<?= wp_registiration_url(); ?>" class="btn btn--small btn--dark-orange float-left">Sign Up</a>
