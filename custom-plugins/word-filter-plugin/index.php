...
class WordFilterPlugin {
    ...
    function replacementFieldHTML() { ?>
        <input type="text" name="replacementText" value="<?= esc_attr(get_option("replacementText", "***")) ?>" class="regular-text">
    ...
    function ourMenu() {
        $mainPageHook = add_menu_page(
            ...
            "ourwordfilter",
            [$this, "wordFilterPage"],
            plugin_dir_url(__FILE__) . 'custom.svg', 100
        );
        // add_menu_page(
        //     "Words To Filter",
        //     "Word Filter",
    ...
    function handleForm() {
       ...
       <?php } else { ?>
            <div class="error">
                <p>Sorry you do not have permission to perform that actiion.</p>
            </div>
      <?php  }
    }
